    ...
    <div className="px-3 pb-6 bg-white">
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-3">
          ...
          {!isAdmin && (
            <div className="mt-4">
              <h1 className="text-lg font-semibold mb-2">Leave Overview</h1>
      ...
      {isAdmin && (
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow-xl p-5 h-[320px] flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <h3 className="text-2xl font-bold text-red-500 mt-1">250</h3>
              </div>

              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-sm text-gray-500">Early Leaving</p>
                <h3 className="text-2xl font-bold text-orange-500 mt-1">250</h3>
              </div>
            </div>

            {/* Pending Requests */}
            <div className="mt-4 bg-gray-50 rounded-lg p-4 flex-1">
          ...
          {
            isAdmin && (<div className="bg-white rounded-xl shadow-xl p-4 h-[320px]">
     ...
     {/* Employee holiday */}
      {!isAdmin && <MonthlyHolidays holidays={holidayList} />}
    </div>
  );
};
